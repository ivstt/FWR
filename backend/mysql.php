...
class MySQL {
    ...
    private $password = "018652"; // Change to the admins password of the server
    private $database = "fwr"; // Change to the name of the database you would like to connect to on the server
